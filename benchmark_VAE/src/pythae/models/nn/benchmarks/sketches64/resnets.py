...
class Decoder_ResNet_VQVAE_MNIST(BaseDecoder):
    ...
    .. code-block::
        ...
        ...     (1): ConvTranspose2d(128, 128, kernel_size=(3, 3), stride=(2, 2), padding=(1, 1), output_padding=(1, 1)) #8
        ...     (2): Sequential(
        ...       (0): ResBlock(
        ...         (conv_block): Sequential(
        ...           (0): ReLU()
    ...
    def __init__(self, args: BaseAEConfig):
        ...
        layers.append(nn.ConvTranspose2d(128, 128, 3, 2, padding=1, output_padding=(1, 1)))
        ...
        layers.append(
            nn.Sequential(
                nn.ConvTranspose2d(
                    32, self.n_channels, 3, 2, padding=1, output_padding=1
                ),
                nn.Sigmoid(),
            )
        )
