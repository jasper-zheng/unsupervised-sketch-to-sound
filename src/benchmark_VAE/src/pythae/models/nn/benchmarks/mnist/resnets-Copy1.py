...
class Encoder_ResNet_VAE_MNIST(BaseEncoder):
    ...
    def __init__(self, args: BaseAEConfig):
        ...
        layers.append(nn.Sequential(nn.Conv2d(32, 64, 4, 2, padding=1))) #14
        layers.append(nn.Sequential(nn.Conv2d(64, 128, 4, 2, padding=1))) #7

        layers.append(nn.Sequential(nn.Conv2d(128, 128, 3, 2, padding=1))) #4
