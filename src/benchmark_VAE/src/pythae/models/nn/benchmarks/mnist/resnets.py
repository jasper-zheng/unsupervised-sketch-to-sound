...
class Encoder_ResNet_VAE_MNIST(BaseEncoder):
    ...
    def __init__(self, args: BaseAEConfig):
        ...
        layers.append(nn.Sequential(nn.Conv2d(self.n_channels, 32, 4, 2, padding=1))) #32
        # layers.append(nn.Sequential(nn.Conv2d(64, 128, 4, 2, padding=1))) #28
        layers.append(nn.Sequential(nn.Conv2d(32, 64, 4, 2, padding=1))) #16
        layers.append(nn.Sequential(nn.Conv2d(64, 128, 4, 2, padding=1))) #8

        layers.append(nn.Sequential(nn.Conv2d(128, 128, 4, 2, padding=1))) #4
...
class Encoder_ResNet_SVAE_MNIST(BaseEncoder):
    ...
    def __init__(self, args: BaseAEConfig):
        ...
        layers.append(nn.Sequential(nn.Conv2d(self.n_channels, 32, 4, 2, padding=1))) #56
        layers.append(nn.Sequential(nn.Conv2d(32, 64, 4, 2, padding=1))) #28
        layers.append(nn.Sequential(nn.Conv2d(64, 128, 4, 2, padding=1))) #14
        layers.append(nn.Sequential(nn.Conv2d(128, 256, 4, 2, padding=1))) #7

        layers.append(nn.Sequential(nn.Conv2d(256, 256, 3, 2, padding=1))) #4
        ...
        self.embedding = nn.Linear(256 * 4 * 4, args.latent_dim)
        self.log_concentration = nn.Linear(256 * 4 * 4, 1)
...
class Decoder_ResNet_AE_MNIST(BaseDecoder):
    ...
    def __init__(self, args: BaseAEConfig):
        ...
        layers.append(nn.ConvTranspose2d(128, 128, 4, 2, padding=1)) #8
        ...
        layers.append(
            nn.Sequential(
                nn.ConvTranspose2d(
                    32, self.n_channels, 4, 2, padding=1
                ),
                nn.Sigmoid(),
            )
        ) #64
